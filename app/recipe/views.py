    ...
    list=extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                description=(
                    'Comma-separated list of tag IDs to filter recipes'
                )
            ),
            OpenApiParameter(
                name='ingredients',
                type=OpenApiTypes.STR,
                description=(
                    'Comma-separated list of ingredient IDs to filter recipes'
                )
            )
        ]
    )
    ...
    list=extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                description='Filter to only show assigned tags or ingredients'
            )
        ]
    )
)
